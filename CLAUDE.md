...
**Açık:**
- 🔜 **UI-3 — Buzz+Chats empty/0-state** (profil güç çubuğu + aktivasyon checklist, sahte like YOK). Aşağıdaki eski "Alt-kalem" ile aynı iş, henüz yapılmadı.
- 🔜 **UI-4 — rn-ui-reviewer pass + push.** Bugünkü/dünkü redesign + Buzz read-side işi için bağımsız review; sonra push.
